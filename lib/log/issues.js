...
exports.transitions = function(err, transitions) {
    if (err) {
        return console.log(err);
    }
    ...
    if (transitions.length === 0) {
        return console.log('No transitions');
    }
...
exports.transition = function(err, object) {
    if (err) {
        return console.log(err);
    }

    console.log('Issue [' + object.issueId + '] is set to ' + object.transitionName);

};

exports.createIssue = function(err, result) {
    if (err) {
        return console.log(err);
    }
